          ...
          <div className="max-w-xl mx-auto space-y-8">
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2 text-[10px] font-black text-[#98A2B3] uppercase tracking-[3px]">
                ...
                <span className="text-[#101828]">Staff Access</span>
              </div>
              <h1 className="text-3xl font-black text-[#101828]">Update Password</h1>
            </div>
            ...
            <div className="bg-white rounded-[40px] border border-[#EAECF0] shadow-sm p-10 md:p-14 relative overflow-hidden group">
               ...
               <div className="flex items-center gap-4 mb-10">
                  <div className="w-12 h-12 rounded-2xl bg-[#101828] text-primary flex items-center justify-center shadow-lg group-hover:rotate-6 transition-transform">
                     <Lock size={24} />
                  </div>
                  <div>
                     <h3 className="text-xl font-black text-[#101828]">Access Security</h3>
                     <p className="text-[#667085] text-xs font-medium italic tracking-wide">Secure your sub-administrative account.</p>
                  </div>
               </div>

               <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                  <div className="space-y-4">
                     <label className="block text-[10px] font-black text-[#667085] uppercase tracking-widest ml-1">Current Staff Password</label>
                  ...
                  <div className="space-y-4">
                     <label className="block text-[10px] font-black text-[#667085] uppercase tracking-widest ml-1">Verify Password</label>
                     <div className="relative">
                        <ShieldCheck className="absolute left-4 top-1/2 -translate-y-1/2 text-[#98A2B3]" size={18} />
                        <input 
