        ...
        <main className="flex-1 p-8 overflow-auto">
          <div className="max-w-[1200px] mx-auto">
            ...
            <div className="flex items-center gap-2 text-[13px] font-medium text-[#999] mb-8">
              ...
              <Link href="/super-admin/marketers" className="hover:text-[#333]">Marketer</Link>
              <ChevronRight size={14} />
            ...
            <div className="bg-white rounded-[20px] shadow-sm border border-[#F2F4F7] p-10">
               <form className="space-y-10">
                  ...
                  <div className="flex items-center gap-4 pt-4">
                     <Link href="/super-admin/marketers" className="px-10 py-4 rounded-lg font-black text-sm uppercase tracking-widest bg-[#EAEAEA] text-[#333] hover:bg-[#DDD] transition-all">
                        CANCEL
                     </Link>
