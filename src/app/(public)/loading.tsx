  ...
  return (
    <div className="fixed top-0 left-0 w-full h-screen bg-white flex flex-col items-center justify-center z-[9999]">
      <div className="flex gap-[10px] mb-5">
        ...
        <div className="w-[15px] h-[15px] bg-primary rounded-full animate-loading-bounce [animation-delay:0.2s]"></div>
        <div className="w-[15px] h-[15px] bg-primary rounded-full animate-loading-bounce [animation-delay:0.4s]"></div>
      </div>
